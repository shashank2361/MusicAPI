...
namespace MyMusic.Api.Controllers
{
    ...
    public class MusicsController : ControllerBase
    {
        ...
        private readonly IMapper _mapper; public MusicsController(IMusicService musicService, IMapper mapper)
        {
            this._mapper = mapper;
        ...
        public async Task<ActionResult<MusicResource>> CreateMusic([FromBody] SaveMusicResource saveMusicResource)
        {
           ...
           return CreatedAtAction(nameof(GetMusicById),   new { id = musicResource.Id }, musicResource);
          //   return CreatedAtRoute("GetMusicById", new { id = musicResource.Id }, musicResource);
